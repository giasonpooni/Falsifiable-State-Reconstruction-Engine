...
- DAF (Data Acquisition Fabric): https://github.com/atomtrapping/Data-Acquisition-Channel at commit `ff92a737f702c5c8ccfe0fb6494b2c2b2af91cb2` -- **not published**. Its published ancestor is `6b378590da3076d88a0f4bd8bad79e1ce0b48ae2` on `claude/daf-state-space-architecture-v8peqd`; the commit `ff92a737f702` (A fourth source: USGS daily values, where the quantity is a statistic) above it is local only and travels as the patch series in `patches/daf/`, which is how this repository carries it without pushing anything to DAF.
