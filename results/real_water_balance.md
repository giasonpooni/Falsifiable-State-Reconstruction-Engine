...
Generated with Python 3.13.12, numpy 2.5.3 on Linux-6.18.44-fc-v24-x86_64-with-glibc2.39; source sha256 c015d3c7a47a, git 246931dc68 (source dirty). Latency columns are wall-clock on this machine and are not a claim.
