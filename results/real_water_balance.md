...
Generated with Python 3.13.12, numpy 2.5.3 on Linux-6.18.44-fc-v24-x86_64-with-glibc2.39; source sha256 662979312047, git 3af69775eb (source dirty). Latency columns are wall-clock on this machine and are not a claim.
