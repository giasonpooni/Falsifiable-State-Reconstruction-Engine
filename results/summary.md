...
| estimator | RMSE all | cov95 all | nz all | |res| post | |corr| | FA (max / rate) | detected ≤100 (k/n) | median delay | held steps | d(f) | lat p50 µs (this machine) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hold_last | 2.01 ± 0.05 | 0.95 | 1.00 | — | — | 0 / 0.0e+00 | — | — | 0 | — | 270 |
| kf | 0.28 ± 0.05 | 0.99 | 0.76 | — | — | 0 / 0.0e+00 | — | — | 0 | — | 341 |
| kf+soft(1/lam=4) | 0.26 ± 0.04 | 0.99 | 0.75 | 2.7e-01 | 0.01 ± 0.00 | 0 / 0.0e+00 | — | — | 0 | — | 451 |
| kf+hard | 0.20 ± 0.04 | 0.99 | 0.75 | 3.9e-16 | 0.21 ± 0.04 | 0 / 0.0e+00 | — | — | 0 | — | 526 |
| kf+hard+guard | 0.20 ± 0.04 | 0.99 | 0.75 | 3.9e-16 | 0.21 ± 0.04 | 0 / 0.0e+00 | — | — | 0 | — | 525 |
...
| kf | 0.69 ± 0.07 | 0.76 | 1.66 | — | — | 0 / 0.0e+00 | 0/20 | > 550 | 0 | 0 | 428 |
| kf+soft(1/lam=4) | 0.67 ± 0.07 | 0.76 | 1.68 | 3.6e-01 | 0.02 ± 0.00 | 0 / 0.0e+00 | 0/20 | > 550 | 0 | 0 | 456 |
| kf+hard | 0.55 ± 0.06 | 0.67 | 2.15 | 3.5e-16 | 0.29 ± 0.05 | 0 / 0.0e+00 | 0/20 | > 550 | 0 | 0 | 537 |
| kf+hard+guard | 0.56 ± 0.07 | 0.68 | 2.15 | 3.5e-16 | 0.29 ± 0.04 | 0 / 0.0e+00 | 0/20 | > 550 | 2 | 0 | 545 |
...
| estimator | RMSE all | cov95 all | nz all | |res| post | |corr| | FA (max / rate) | detected ≤100 (k/n) | median delay | held steps | d(f) | lat p50 µs (this machine) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hold_last | 6.38 ± 1.01 | 0.74 | 3.03 | — | — | 0 / 0.0e+00 | 0/20 | 192 | 0 | 0 | 274 |
| kf | 0.76 ± 0.31 | 0.77 | 1.60 | — | — | 0 / 0.0e+00 | 0/20 | > 600 | 0 | 0 | 345 |
| kf+soft(1/lam=4) | 0.71 ± 0.27 | 0.77 | 1.60 | 5.2e-01 | 0.06 ± 0.03 | 0 / 0.0e+00 | 0/20 | > 600 | 0 | 0 | 566 |
| kf+hard | 0.52 ± 0.14 | 0.68 | 1.99 | 4.0e-16 | 0.48 ± 0.24 | 0 / 0.0e+00 | 0/20 | > 600 | 0 | 0 | 540 |
| kf+hard+guard | 0.55 ± 0.25 | 0.68 | 1.99 | 4.1e-16 | 0.46 ± 0.20 | 0 / 0.0e+00 | 0/20 | > 600 | 6 | 0 | 541 |
...
| estimator | RMSE all | cov95 all | nz all | |res| post | |corr| | FA (max / rate) | detected ≤100 (k/n) | median delay | held steps | d(f) | lat p50 µs (this machine) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| hold_last | 1.97 ± 0.03 | 0.95 | 0.99 | — | — | 0 / 0.0e+00 | 0/20 | 166 | 0 | 0.125 | 278 |
| kf | 0.79 ± 0.04 | 0.79 | 2.43 | — | — | 1 / 1.7e-04 | 20/20 | 66 | 0 | 4.93 | 352 |
| kf+soft(1/lam=4) | 0.84 ± 0.04 | 0.77 | 2.64 | 2.7e+00 | 0.10 ± 0.00 | 1 / 1.7e-04 | 20/20 | 66 | 0 | 4.93 | 467 |
| kf+hard | 2.69 ± 0.01 | 0.53 | 11.94 | 5.2e-16 | 1.99 ± 0.06 | 1 / 1.7e-04 | 20/20 | 66 | 0 | 4.93 | 554 |
| kf+hard+guard | 0.81 ± 0.05 | 0.76 | 2.80 | 6.2e-16 | 0.26 ± 0.06 | 1 / 1.7e-04 | 20/20 | 66 | 235 | 4.93 | 527 |
...
| kf | 1.63 ± 0.06 | 0.67 | 4.79 | — | — | 0 / 0.0e+00 | 20/20 | 36 | 0 | 4.37 | 352 |
| kf+soft(1/lam=4) | 1.58 ± 0.06 | 0.67 | 4.73 | 1.8e+00 | 0.08 ± 0.01 | 0 / 0.0e+00 | 20/20 | 36 | 0 | 4.37 | 458 |
| kf+hard | 1.16 ± 0.06 | 0.36 | 4.82 | 4.3e-16 | 1.34 ± 0.07 | 0 / 0.0e+00 | 20/20 | 36 | 0 | 4.37 | 538 |
| kf+hard+guard | 1.61 ± 0.06 | 0.66 | 4.80 | 9.2e-16 | 0.29 ± 0.06 | 0 / 0.0e+00 | 20/20 | 36 | 362 | 4.37 | 447 |
...
| kf | 0.28 ± 0.04 | 0.99 | 0.73 | — | — | 0 / 0.0e+00 | — | — | 0 | — | 329 |
| kf+soft(1/lam=4) | 0.26 ± 0.04 | 0.99 | 0.72 | 2.6e-01 | 0.02 ± 0.00 | 0 / 0.0e+00 | — | — | 0 | — | 539 |
| kf+hard | 0.20 ± 0.05 | 0.99 | 0.72 | 3.6e-16 | 0.20 ± 0.03 | 0 / 0.0e+00 | — | — | 0 | — | 525 |
| kf+hard+guard | 0.20 ± 0.05 | 0.99 | 0.72 | 3.6e-16 | 0.20 ± 0.03 | 0 / 0.0e+00 | — | — | 0 | — | 521 |
