...
| Cooling-manifold procurement study | How many metered circuits are worth buying, computed before any are: conservation alone isolates nothing because a fouling circuit conserves energy, the duty row reaches 18 of 19, and the answer is still the hardest pair rather than the count — the declared heat load binds two orders of magnitude harder than the meter count does. | [Circuit study](results/cooling_circuits.md) |
