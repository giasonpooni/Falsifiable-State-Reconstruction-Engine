...
This is the long form. `README.md` carries the summary and the use case; this is where the
working is. It is arranged chronologically, because each phase was a response to what the
previous one failed to answer, and that order is the argument.
