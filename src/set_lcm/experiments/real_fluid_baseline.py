...
def build_report(*, window_days: int = WINDOW_DAYS) -> dict:
    ...
    return {
        "schema_version": "fsre-real-fluid-baseline-v1",
...
def render(report: dict) -> str:
    lines = ["# Real fluid-measurement baseline — Ridgway", "",
             ...
             f"Fixed windows contain at most {report['declared']['window_days']} days. No sensor cause is assigned.", "",
